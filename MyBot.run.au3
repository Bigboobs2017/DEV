...
Global $g_sModversion = "v3.7.3" ;<== Just Change This to Version Number
...
NotifyGetLastMessageFromTelegramBtnStart()
...
Func runBot() ;Bot that runs everything in order
	...
	While 1
		...
		If $g_bIsClientSyncError = False And $g_bIsSearchLimit = False And ($g_bQuickAttack = False) Then
			...
			Local $aRndFuncList = ['Collect', 'CheckTombs', 'ReArm', 'CleanYard', 'CollectTreasury', 'GoToBBFeatures', 'LabCheck']
			; ================================================== ADDITION BY ROROTITI - PICO MOD ================================================== ;
			While 1
