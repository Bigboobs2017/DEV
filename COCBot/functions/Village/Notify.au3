			...
			If $g_iTGLastRemote <> $g_sTGLast_UID Then
				...
				Switch $TGActionMSG
					...
					Case GetTranslatedFileIni("MBR Func_Notify", "STATS", "STATS"), '\UD83D\UDCC8 ' & GetTranslatedFileIni("MBR Func_Notify", "STATS", "STATS")
						...
						$txtStats &= "\n\n" & "Builder Base"
						$txtStats &= "\n\n" &"[G]: " & _NumberFormat($g_iGoldBB) & " [E]: " & _NumberFormat($g_iElixirBB) & " [T]: " & _NumberFormat($g_iTrophiesBB)
						$txtStats &= "\n\n" & "[Master Builder]: " & $g_aBuilder[0] &"/" & $g_aBuilder[1]
...
Func NotifyPushMessageToBoth($Message, $Source = "")
	...
	Switch $Message
	    ...
	    Case "BB_AvailableAtk"
		     If $g_bNotifyTGEnable = True And $g_bNotifyRemoteEnable = True Then
			   NotifyPushToBoth($g_sNotifyOrigin & " | " & "Hey, Chief!! You have " & $g_iAttacksAvailable & " available attacks!")
			 EndIf
