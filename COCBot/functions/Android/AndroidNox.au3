...
Func InitNox($bCheckOnly = False)
	...
	If Not $bCheckOnly Then
		...
		If Not @error Then
			...
			If $g_iDebugSetlog Then Setlog("Func LaunchConsole: Read $g_sAndroidAdbDeviceHost = " & $g_sAndroidAdbDeviceHost, $COLOR_DEBUG)
		Else
			$oops = 1
		...
		If Not @error Then
			...
			If $g_iDebugSetlog Then Setlog("Func LaunchConsole: Read $g_sAndroidAdbDevicePort = " & $g_sAndroidAdbDevicePort, $COLOR_DEBUG)
		Else
			$oops = 1
