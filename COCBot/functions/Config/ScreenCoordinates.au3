...
Global $aIsMain[4] = [279, 8, 0x78BDE0, 10] ; Main Screen, Builders 'i'-Button
...
Global $aIsMainGrayed[4] = [279, 8, 0x3C5F70, 15] ; Main Screen Grayed, Builders 'i'-Button
Global $aIsOnBuilderIsland[4] = [386, 12, 0x658bb2, 10] ; Check the Purle color on Elixir from resources
...
Global $aArmyCCRemainTime[2] = [770, 545] ; Training Window Overviewscreen, Minutes & Seconds remaining till can request again
...
Global Const $ProfileRep01[4] = [600, 352, 0x4e4d79, 10] ; If colorcheck then village have 0 attacks and 0 defenses
