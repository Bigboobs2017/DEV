...
Global $aTabControlsVillage, $aTabControlsDonate, $aTabControlsUpgrade, $aTabControlsNotify , $aTabControlsMOD
; ================================================== ADDITION BY ROROTITI - PICO MOD ================================================== ;
...
;   Dim $aTabControlsMOD = [$g_hGUI_MOD_TAB, $g_hGUI_MOD_TAB_ITEM1, $g_hGUI_MOD_TAB_ITEM2, $g_hGUI_MOD_TAB_ITEM3, $g_hGUI_MOD_TAB_ITEM4, $g_hGUI_MOD_TAB_ITEM5]
   Dim $aTabControlsMOD = [$g_hGUI_MOD_TAB, $g_hGUI_MOD_TAB_ITEM1, $g_hGUI_MOD_TAB_ITEM2, $g_hGUI_MOD_TAB_ITEM3, $g_hGUI_MOD_TAB_ITEM5, $g_hGUI_MOD_TAB_ITEM6, $g_hGUI_MOD_TAB_ITEM8]
; ================================================== ADDITION BY ROROTITI - PICO MOD ================================================== ;
