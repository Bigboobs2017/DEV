...
Func ChatGuiEditUpdate()
 ...
 $cGeneric = GUICtrlRead($editGeneric)
	...
	$cGeneric = StringReplace($cGeneric, @CRLF, "|")
		...
		;IniWrite($g_sProfileConfigPath, "Pico Chatbot", "globalMsg1", $glb1)
		;IniWrite($g_sProfileConfigPath, "Pico Chatbot", "globalMsg2", $glb2)
		;IniWrite($g_sProfileConfigPath, "Pico Chatbot", "globalMsg3", $glb3)
		;IniWrite($g_sProfileConfigPath, "Pico Chatbot", "globalMsg4", $glb4)

	;IniWrite($g_sProfileConfigPath, "Pico Chatbot", "genericMsgClan", $cGeneric)
	;IniWrite($g_sProfileConfigPath, "Pico Chatbot", "responseMsgClan", $cResp)
