...
Global $g_hCmbCOCDistributors = 0, $g_hCmbAndroidBackgroundMode = 0, $g_hCmbSuspendAndroid = 0, $g_hChkAndroidAdbClickDragScript = 0, $g_hTxtAndroidRebootHours = 0

Func CreateBotAndroid()
	Local $x = 25, $y = 45, $y2, $w = 210, $h = 50, $sTxtTip
