...
Func CreateBottomPanel()
   ...
   GUICtrlCreateGroup("https://mybot.run " & GetTranslatedFileIni("MBR GUI Design Bottom", "Group_01", "- freeware bot -"), $x - 5, $y - 10, 190, 108)
	   ...
	   $g_hLblDonate = GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Bottom", "LblDonate", "Support the development"), $x + 300, $y + 80, 150, -1, $SS_RIGHT)
   ...
   ;$g_hLblVersion = GUICtrlCreateLabel($g_sBotVersion, 200, $y + 60, 60, 17, $SS_CENTER) ; MAKE ROOM FOR ROYAL AND LAB STATUS
   $g_hLblVersion = GUICtrlCreateLabel($g_sBotVersion, 279, $y + 80, 35, 17, $SS_LEFT)
